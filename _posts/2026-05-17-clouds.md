...
The first thing that I could start with for my skillset and short time until the deadline would be Executable Graphics in a maximum 4096 bytes executable, so I decided to give it a try.
